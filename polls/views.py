...
def query_view(request):
    if request.method == "POST":
        ...
        prompt = (
            "\n".join(fullText)
            + " Based on the above notes, generate 3 multiple choice question with 4 answer choices. Please give the correct answers at the end of your response in a separate section. For example: Q1: blah blah Q2: blah blah Correct Answers: blah blah"
        )
